"""
This code is part of the github repository AIMA-PYTHON, which corresponds to the book Artificial
Intelligence. A Modern Approach. Moreover by Peter Norving and Stuart Russell, 
this code is part of the chapters 3-4.

The code is taken for the examples of the subject Artificial Intelligence in Operative
Research of the University of Granada.

The adaptation of the code is conducted by Eugenio Martínez Cámara at 07.11.2022.
...
class Problem:
    ...
    def h(self, node):
        """It correspond with the default heuristic.
        """
        return 0
